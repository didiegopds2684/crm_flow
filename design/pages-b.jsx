  ...
  <div style={{ padding: 28, display:"grid", gridTemplateColumns:"320px 1fr", gap: 18, overflow:"auto", height:"100%" }}>
    <div style={{ display:"flex", flexDirection:"column", gap: 12 }}>
      <div style={{ display:"flex", alignItems:"center", gap:8 }}>
        ...
        <AccentBtn style={{ padding:"8px 12px", fontSize: 13 }}>+ Nova</AccentBtn>
      </div>
    ...
    <div style={{ display:"flex", flexDirection:"column", gap: 14 }}>
      <Card>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
          ...
          <div style={{ display:"flex", gap: 8 }}>
            <GhostBtn>Duplicar</GhostBtn>
            <GhostBtn>Exportar schema</GhostBtn>
            <PrimaryBtn>Publicar alterações</PrimaryBtn>
          </div>
        </div>
      ...
      <Card style={{ padding: 0 }}>
        <div style={{ padding:"14px 18px", borderBottom:"1px solid var(--line)", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          ...
          <div style={{ display:"flex", gap: 8 }}>
            <GhostBtn>Importar JSON</GhostBtn>
            <AccentBtn>+ Adicionar campo</AccentBtn>
          </div>
        </div>
  ...
  return (
    <div style={{ padding: 28, display:"flex", flexDirection:"column", gap: 18, overflow:"auto" }}>
      <div style={{ display:"flex", alignItems:"center", gap: 10, flexWrap:"wrap" }}>
        ...
        <GhostBtn>Agrupar ▾</GhostBtn>
        <GhostBtn>Ordenar ▾</GhostBtn>
        <AccentBtn>+ Novo lead</AccentBtn>
      </div>
